...
output "ws_events_queue_url" {
  description = "SQS URL for WebSocket event processing queue"
  value       = aws_sqs_queue.ws_events.url
}

output "session_cleanup_queue_url" {
  description = "SQS URL for session cleanup queue (Lambda processes GameLift session-ended events)"
  value       = aws_sqs_queue.session_cleanup.url
}

output "roll_archive_queue_url" {
  description = "SQS URL for roll log archival queue"
  value       = aws_sqs_queue.roll_archive.url
}
