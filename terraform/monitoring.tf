...
resource "aws_cloudwatch_metric_alarm" "alb_5xx" {
  ...
  # ALB CloudWatch dimensions require the ARN suffix (app/name/id), not the plain name
  dimensions = {
      ...
      },
      {
        ...
        properties = {
          ...
          metrics = [
            ...
            ["AWS/ApplicationELB", "HTTPCode_ELB_5XX_Count",   "LoadBalancer", module.ecs.alb_arn_suffix],
